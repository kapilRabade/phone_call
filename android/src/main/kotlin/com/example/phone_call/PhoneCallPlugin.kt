...
internal class FlutterPhoneDirectCallerHandler :
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        if (call.method == "callUser") {
            ...
            if (permissionStatus != 1) {
                ...
                result.success(this.callUser(number))
            }
        } else {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == CALL_REQ_CODE) {
            ...
            flutterResult!!.success(this.callUser(number))
        }
        return true
    }
    ...
    private fun callUser(number: String?): Boolean {
        return try {
